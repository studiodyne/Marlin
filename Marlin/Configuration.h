...
#define CUSTOM_MACHINE_NAME "Tronxydual V10-Mbf2.1"
...
#define SWITCHING_NOZZLE
  ...
  #define SWITCHING_NOZZLE_SERVO_ANGLES { 62, 71}   // Angles for E0, E1 (single servo) or lowered/raised (dual servo)
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 14.1f , 14.1f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.149f , 0.1492f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.004f , 0.004f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.020f , 0.020f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 25, Y_MIN_POS, 5 }
...
#define NOZZLE_CLEAN_STROKES  4
  ...
  #define NOZZLE_CLEAN_START_POINT { { 0, -30, 2 }, { 0, -30, 2 } }
  #define NOZZLE_CLEAN_END_POINT   { { 40, -30, 2 }, { 40, -30, 2 } }
