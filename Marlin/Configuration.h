...
#define CUSTOM_MACHINE_NAME "V251214"
...
#define SWITCHING_NOZZLE
  ...
  #define SWITCHING_NOZZLE_SERVO_ANGLES { { 62, 95}, { 62, 95} }   // A pair of angles for { E0, E1 }.
                                                    // For Dual Servo use two pairs: { { lower, raise }, { lower, raise } }
  #define SWITCHING_NOZZLE_SERVO_DWELL 1000         // Dwell time to wait for servo to make physical move
...
#define HOTEND_OFFSET_X { 0.0, 54 } // (mm) relative X-offset for each nozzle
 ...
 */
  ...
  #define MPC_HEATER_POWER { 70.0f, 70.0f }                   // (W) Nominal heat cartridge powers.
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 18.67f , 18.67f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.4205f , 0.4205f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0056f , 0.0056f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.017f , 0.017f  }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
  ...
  #define MPC_TUNING_POS { X_CENTER, 20 } // (mm) M306 Autotuning position, ideally bed center at first layer height.
...
#define PIDTEMPBED
  ...
  // Tronxy
  #define DEFAULT_BED_KP 114.25
  #define DEFAULT_BED_KI 15.69
  #define DEFAULT_BED_KD 554.48
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 200, 107.5 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { G0_FEEDRATE/60, G0_FEEDRATE/60, 20, 150 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  //#define MAX_FEEDRATE_EDIT_VALUES    { G0_FEEDRATE/60, G0_FEEDRATE/60, 25, 150  } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 80, 9000}
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 27, 12.5, -0.0 }
...
#define PREHEAT_5_FAN_SPEED     0 // Value from 0 to 2555
*/
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { X_MIN_POS + 60, Y_MIN_POS + 10, 0 }
  #define NOZZLE_PARK_MOVE          0   // Park motion: 0 = XY Move, 1 = X Only, 2 = Y Only, 3 = X before Y, 4 = Y before X
  #define NOZZLE_PARK_Z_RAISE_MIN   0.5   // (mm) Always raise Z by at least this distance
