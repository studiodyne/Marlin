...
#define CUSTOM_MACHINE_NAME "Tronxydual V18"
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 8, 150 }

//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  //#define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 25, 150 } // ...or, set your own edit limits
#endif
...
#define PREHEAT_2_LABEL       "ABS/NYLON/PC"
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 27, Y_MIN_POS, 5 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { { 45, -30, 5 }, { 45, -30, 5  } }
  #define NOZZLE_CLEAN_END_POINT   { { 95, -23, 5 }, { 95, -23, 5 } }
...
#define RGBW_LED
  ...
  #define RGB_STARTUP_TEST              // For PWM pins, fade between all colors
    ...
    #define RGB_STARTUP_TEST_INNER_MS 3  // (ms) Reduce or increase fading speed
  #endif
#endif
