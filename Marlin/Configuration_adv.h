...
#define CALIBRATION_GCODE
  ...
  #define CALIBRATION_FEEDRATE_TRAVEL      G0_FEEDRATE * 60   // mm/min
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     (TOOLCHANGE_FS_RETRACT_SPEED / 60)  // (mm/s) Unload filament feedrate. This can be pretty fast.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   (TOOLCHANGE_FS_RETRACT_SPEED / 60) // (mm/s) Load filament feedrate. This can be pretty fast.
