...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 8*60, 6*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
  ...
  #define TOOLCHANGE_FILAMENT_SWAP
    ...
    #define TOOLCHANGE_FS_EXTRA_RESUME_LENGTH -1  // (mm) Extra length for better restart, fine tune by LCD/Gcode)
    ...
    #define TOOLCHANGE_FS_WIPE_RETRACT        10  // (mm/min) Retract before cooling for less stringing, better wipe, etc.
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        RETRACT_FEEDRATE  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  ...
  #define FILAMENT_UNLOAD_PURGE_FEEDRATE     4.6  // (mm/s) feedrate to purge before unload
