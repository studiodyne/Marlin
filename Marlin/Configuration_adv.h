...
//
  ...
  #define HOTEND0_PULLUP_RESISTOR_OHMS    4700 // Pullup resisto  rM305 P0 R4700 B6400 T2500000 C0.000000100925
  #define HOTEND0_RESISTANCE_25C_OHMS  2500000 // Resistance at 25C
  #define HOTEND0_BETA                    6350 // Beta value
  #define HOTEND0_SH_C_COEFF    0.000000100925 // Steinhart-Hart C coefficient
#endif

#if TEMP_SENSOR_1 == 1000
  #define HOTEND1_PULLUP_RESISTOR_OHMS    4700 // Pullup resistor
  #define HOTEND1_RESISTANCE_25C_OHMS  2500000 // Resistance at 25C
  #define HOTEND1_BETA                    6350 // Beta value
  #define HOTEND1_SH_C_COEFF   0.000000100925  // Steinhart-Hart C coefficient
#endif
...
#define HOMING_BACKOFF_POST_MM { 10, 0, 0 }  // (linear=mm, rotational=°) Backoff from endstops after homing
#define XY_COUNTERPART_BACKOFF_MM 10         // (mm) Backoff X after homing Y, and vice-versa
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { { 10, 10 }, { 455,  10 }, { 455, 440 }, {10, 440 } }
...
//#define INPUT_SHAPING_Z
    ...
    #define SHAPING_FREQ_X  20.0        // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X   0.15       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  20.0        // (Hz) The default dominant resonant frequency on the Y axis.
...
#define CALIBRATION_GCODE
  ...
  #define CALIBRATION_FEEDRATE_TRAVEL           G0_FEEDRATE  // mm/min
  ...
  #define CALIBRATION_OBJECT_CENTER     { 395, -30, 10 } // mm
  #define CALIBRATION_OBJECT_DIMENSIONS {  35,  35,  7 } // mm
  ...
  #define CALIBRATION_MEASUREMENT_UNCERTAIN 2 // mm
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 40*60, 4.6*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  //#define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_RECOVER_ZHOME
      ...
      #define POWER_LOSS_ZHOME_POS { 50, Y_MAX_POS } // Safe XY position to home Z while avoiding objects on the bed
    #endif
  #endif
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.06 }    // (mm) Compression length per 1mm/s extruder speed, per extruder. Override with 'M900 T<tool> K<mm>'.
  #else
...
#define FWRETRACT
  ...
  #define RETRACT_LENGTH_SWAP           50   // (mm) Default swap retract length (positive value)
 ...
 */
  ...
  //#define TOOLCHANGE_ZRAISE_BEFORE_RETRACT  // Apply raise before swap retraction (if enabled)
    ...
    #define EVENT_GCODE_AFTER_TOOLCHANGE "M812"   // Extra G-code to run after tool-change
  #endif
   ...
   */
  //#define EVENT_GCODE_TOOLCHANGE_T0 "G0 X60 Y-40 F14400" // Extra G-code to run while executing tool-change command T0
  //#define EVENT_GCODE_TOOLCHANGE_T1 EVENT_GCODE_TOOLCHANGE_T0      // Extra G-code to run while executing tool-change command T1
  ...
  #define TOOLCHANGE_FILAMENT_SWAP
    ...
    #define TOOLCHANGE_FS_WIPE_RETRACT          0 // (mm) Retract before cooling for less stringing, better wipe, etc.Adjust with LCD or M217 W.
  ...
  #define TOOLCHANGE_PARK
    ...
    #define TOOLCHANGE_PARK_XY    NOZZLE_PARK_POINT //{27, Y_MIN_POS +10 }
    #define TOOLCHANGE_PARK_XY_FEEDRATE G0_FEEDRATE // (mm/min)
    //#define TOOLCHANGE_PARK_X_ONLY          // X axis only move
    //#define TOOLCHANGE_PARK_Y_ONLY          // Y axis only move
    #define TOOLCHANGE_MACRO_BEFORE "M810"
    #define TOOLCHANGE_MACRO_RETRACTED "M811"

    #if ENABLED(TOOLCHANGE_MIGRATION_FEATURE)
    #define MIGRATION_MACRO_BEFORE "G60S0" //Store position
    #define MIGRATION_MACRO_AFTER  "G61S0F15000" //Restore position
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE   (TOOLCHANGE_FS_PRIME_SPEED / 60) // (mm/s) Slow move when starting load.
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH     10  // (mm) Slow length, to allow time to insert material.
                                                  // 0 to disable start loading and skip to fast load only
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   RETRACT_FEEDRATE // (mm/s) Load filament feedrate. This can be pretty fast.
 ...
 */
  ...
  #define X_HYBRID_THRESHOLD     253  // [mm/s]
  #define X2_HYBRID_THRESHOLD      3
  #define Y_HYBRID_THRESHOLD     253
  #define Y2_HYBRID_THRESHOLD      3
...
//#define NO_VOLUMETRICS
  ...
  #define VOLUMETRIC_EXTRUDER_LIMIT
    ...
    #define VOLUMETRIC_EXTRUDER_LIMIT_MAX     50        // (mm^3/sec)
  #endif
#endif
...
#define CUSTOM_MENU_CONFIG
  ...
  #define CUSTOM_MENU_CONFIG_TITLE "Cmdes risquées"
  //#define CUSTOM_MENU_CONFIG_SCRIPT_DONE "M117 Wireless Script Done"
  //#define CUSTOM_MENU_CONFIG_SCRIPT_AUDIBLE_FEEDBACK
  //#define CUSTOM_MENU_CONFIG_SCRIPT_RETURN  // Return to status screen after a script
  //#define CUSTOM_MENU_CONFIG_ONLY_IDLE        // Only show custom menu when the machine is idle

  #define CONFIG_MENU_ITEM_1_DESC  "Homing clr"
  #define CONFIG_MENU_ITEM_1_GCODE "G425S\nG28"
  //#define CONFIG_MENU_ITEM_1_CONFIRM        // Show a confirmation dialog before this action
  #define CONFIG_MENU_ITEM_1_IMMEDIATE      // Skip the queue and execute immediately. Rarely needed.

  #define CONFIG_MENU_ITEM_2_DESC  "ToolChange neutre"
  #define CONFIG_MENU_ITEM_2_GCODE "M217 W0 E0 D0 G0 S0 B0 Z0"
  //#define CONFIG_MENU_ITEM_2_CONFIRM
  #define CONFIG_MENU_ITEM_2_IMMEDIATE

  #define CONFIG_MENU_ITEM_3_DESC  "T0 Volcano"
  #define CONFIG_MENU_ITEM_3_GCODE "G425S\nM306 E0 P70.00 C20.23 R0.6171 A0.0202 F0.0206\nM500"
  //#define CONFIG_MENU_ITEM_3_CONFIRM
  #define CONFIG_MENU_ITEM_3_IMMEDIATE

  #define CONFIG_MENU_ITEM_4_DESC  "T1 Volcano"
  #define CONFIG_MENU_ITEM_4_GCODE "G425S\nM306 E1 P70.00 C20.23 R0.6171 A0.0202 F0.0206\nM500"
  //#define CONFIG_MENU_ITEM_4_CONFIRM
  #define CONFIG_MENU_ITEM_4_IMMEDIATE

  #define CONFIG_MENU_ITEM_5_DESC "T0 Revo"
  #define CONFIG_MENU_ITEM_5_GCODE "G425S\nM306 E0 P69.90 C15.31 R0.3927 A0.0118 F0.0178\nM500" //before thermistor switch bG425S\nM306 E0 B1\nM306 E0 P40.00 C15.2879 R0.3629 A0.0386 F0.1260\nM500\nG4S3\nM306 M"
  //#define CONFIG_MENU_ITEM_5_CONFIRM

  #define CONFIG_MENU_ITEM_6_DESC "T1 Revo"
  #define CONFIG_MENU_ITEM_6_GCODE "G425S\nM306 E1 P69.90 C15.31 R0.3927 A0.0118 F0.0178\nM500"
  #define CONFIG_MENU_ITEM_6_IMMEDIATE

  #define CONFIG_MENU_ITEM_7_DESC  "T0 SuperVolcano"
  #define CONFIG_MENU_ITEM_7_GCODE "G425S\nM306 E0 P80.00 C57.90 R0.1668 A-0.0362 F0.0130\nM500"
  //#define CONFIG_MENU_ITEM_7_CONFIRM
  #define CONFIG_MENU_ITEM_7_IMMEDIATE

  #define CONFIG_MENU_ITEM_8_DESC  "T1 SuperVolcano"
  #define CONFIG_MENU_ITEM_8_GCODE "G425S\nM306 E1 P80.00 C57.90 R0.1668 A-0.0362 F0.0130\nM500"
  //#define CONFIG_MENU_ITEM_8_CONFIRM
  #define CONFIG_MENU_ITEM_8_IMMEDIATE

  #define CONFIG_MENU_ITEM_9_DESC  "Full Volcano"
  #define CONFIG_MENU_ITEM_9_GCODE "G425S\nM306 E0 P70.00 C20.23 R0.6171 A0.0202 F0.020\nM306 E1 P70.00 C20.23 R0.6171 A0.0202 F0.020\nM500"
  //#define CONFIG_MENU_ITEM_9_CONFIRM
  #define CONFIG_MENU_ITEM_9_IMMEDIATE

  #define CONFIG_MENU_ITEM_10_DESC "Full Revo"
  #define CONFIG_MENU_ITEM_10_GCODE "G425S\nM306 E0 P69.90 C15.31 R0.3927 A0.0118 F0.0178\nM306 E1 P69.90 C15.31 R0.3927 A0.0118 F0.0178\nM500"
  //#define CONFIG_MENU_ITEM_10_CONFIRM
  #define CONFIG_MENU_ITEM_10_IMMEDIATE

  #define CONFIG_MENU_ITEM_11_DESC  "Full SuperVolcano"
  #define CONFIG_MENU_ITEM_11_GCODE "G425S\nM306 E0 P80.01 C57.90 R0.1668 A-0.0362 F0.0130\nM306 E1 P80.01 C57.90 R0.1668 A-0.0362 F0.0130\nM500"
  //#define CONFIG_MENU_ITEM_11_CONFIRM

  #define CONFIG_MENU_ITEM_12_DESC  "Calibration"
  #define CONFIG_MENU_ITEM_12_GCODE "G425S\nM104 T1 S220\nM104 T0 S220\nM109 T1 S220\nM109 T0 S220\nG425\nM104 T1 S0\nM104 T0 S0"
  //#define CONFIG_MENU_ITEM_12_CONFIRM  #define CONFIG_MENU_ITEM_3_DESC "T0 Volcano"
  #define CONFIG_MENU_ITEM_12_IMMEDIATE

  #define CONFIG_MENU_ITEM_13_DESC  "T0 +G60"
  #define CONFIG_MENU_ITEM_13_GCODE "G60\nT0\nG61F14400"
  //#define CONFIG_MENU_ITEM_13_CONFIRM
  #define CONFIG_MENU_ITEM_13_IMMEDIATE

  #define CONFIG_MENU_ITEM_14_DESC  "T1 +G60"
  #define CONFIG_MENU_ITEM_14_GCODE "G60\nT1\nG61F14400"
  //#define CONFIG_MENU_ITEM_14_CONFIRM
  #define CONFIG_MENU_ITEM_14_IMMEDIATE

  #define CONFIG_MENU_ITEM_15_DESC  "Tools HIGH"
  #define CONFIG_MENU_ITEM_15_GCODE "M280 H1"
  //#define CONFIG_MENU_ITEM_15_CONFIRM
  #define CONFIG_MENU_ITEM_15_IMMEDIATE

  #define CONFIG_MENU_ITEM_16_DESC  "Tools LOW"
  #define CONFIG_MENU_ITEM_16_GCODE "M280 H0"
  //#define CONFIG_MENU_ITEM_16_CONFIRM
  #define CONFIG_MENU_ITEM_16_IMMEDIATE

  #define CONFIG_MENU_ITEM_17_DESC  "Tools Invertion"
  #define CONFIG_MENU_ITEM_17_GCODE "M280 I"
  //#define CONFIG_MENU_ITEM_17_CONFIRM
  #define CONFIG_MENU_ITEM_17_IMMEDIATE

  #define CONFIG_MENU_ITEM_18_DESC  "PARK"
  #define CONFIG_MENU_ITEM_18_GCODE "G27"
  //#define CONFIG_MENU_ITEM_18_CONFIRM
  #define CONFIG_MENU_ITEM_18_IMMEDIATE

  #define CONFIG_MENU_ITEM_19_DESC  "M125T"
  #define CONFIG_MENU_ITEM_19_GCODE "M125T"
  //#define CONFIG_MENU_ITEM_19_CONFIRM
  #define CONFIG_MENU_ITEM_19_IMMEDIATE

  #define CONFIG_MENU_ITEM_20_DESC  "Mesure lit PLA"
  #define CONFIG_MENU_ITEM_20_GCODE "G425S\nG29NP1\nG29S1\nG29S0\nG29L1"
  //#define CONFIG_MENU_ITEM_20_CONFIRM
  #define CONFIG_MENU_ITEM_20_IMMEDIATE

  #define CONFIG_MENU_ITEM_21_DESC  "Mesure lit ABS"
  #define CONFIG_MENU_ITEM_21_GCODE "G425S\nG29NP1\nG29S2\nG29L2"
  //#define CONFIG_MENU_ITEM_21_CONFIRM
  #define CONFIG_MENU_ITEM_21_IMMEDIATE
