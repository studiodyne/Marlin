 ...
 */ 
 const unsigned char status_chamber_bmp[] PROGMEM = {
  ...
  B00000010,B01000001,B00000000, // ···▌▐··▐····
  B00000010,B01000010,B10000000, // ···▌▐··▌▌···
  B00000010,B01000001,B00000000, // ···▌▐··▐····
  B00000010,B01000000,B00000000, // ···▌▐·······
  B00000010,B01000000,B11100000, // ···▌▐···█▌··
  B00000010,B01000001,B00000000, // ···▌▐··▐····
  B00000100,B00100010,B00000000, // ··▐··▌·▌····
  B00001000,B00010010,B00000000, // ··▌··▐·▌····
  B00001000,B00010010,B00000000, // ··▌··▐·▌····
  B00000100,B00100001,B00000000, // ··▐··▌·▐····
  B00000011,B11000000,B11100000  // ···██···█▌··
};
