...
class Temperature {
  ...
  public:
    ...
    #if HAS_HOTEND
      static bool thermistor_sets[HOTENDS];
      ...
      static constexpr celsius_t hotend_max_target(const uint8_t e) {
        const  bool thermistor_sets_max = thermistor_sets[e];
        return hotend_maxtemp[thermistor_sets_max] - (HOTEND_OVERSHOOT); }
    #endif
